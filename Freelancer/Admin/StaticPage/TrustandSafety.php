			...
			<div class="container">
				...
				<?php 
					...
					WHERE	CodeId            = '44444' ";	
							...
							$Check = mysql_query("SELECT * FROM admin_staticpage where CodeId='44444'");
									...
									<div class="table-footer">
										<div class="col-md-12" >
											<div class="table-actions">
												...
												<input type="submit" id="submit-visit" name="TrustandSafety" value="Update" class="btn btn-primary pull-center">								
									</form>	
