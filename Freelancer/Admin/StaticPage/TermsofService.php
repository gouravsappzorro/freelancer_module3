			...
			<div class="container">
				...
				<div class="row">
					...
					WHERE	CodeId            = '22222' ";	
							...
							$Check = mysql_query("SELECT * FROM admin_staticpage where CodeId='22222'");
									...
									<div class="table-footer">
										<div class="col-md-12" >
											<div class="table-actions">
												...
												<input type="submit" id="submit-visit" name="TermofService" value="Update" class="btn btn-primary pull-center">								
									</form>	
