		...
		<div id="content">
			...
			<?php 
					...
					WHERE	CodeId            = '55555' ";	
							...
							$Check = mysql_query("SELECT * FROM admin_staticpage where CodeId='55555'");
									...
									<div class="table-footer">
										<div class="col-md-12" >
											<div class="table-actions">
												...
												<input type="submit" id="submit-visit" name="Careers" value="Update" class="btn btn-primary pull-center">								
									</form>	
