			...
			<div class="container">
				...
				<?php 
					...
					WHERE	CodeId            = '11111' ";	
							...
							$Check = mysql_query("SELECT * FROM admin_staticpage where CodeId='11111'");
									...
									<div class="table-footer">
										<div class="col-md-12" >
											<div class="table-actions">
												<input type="submit" id="submit-visit" name="Aboutus" value="Update" class="btn btn-primary pull-center">								
									</form>	
											</div>
										</div>
									</div> <!-- /.table-footer -->
