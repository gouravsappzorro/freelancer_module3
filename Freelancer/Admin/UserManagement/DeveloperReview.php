			...
			<div class="container">
                ...
                <div class="col-md-12">
                    <div class="widget box">
                        ...
                        <?php
						$sql_review=mysql_query("select * from rating where developer_id='$_GET[TestCode]'");
						if(mysql_affected_rows())
						{
							while($row_review=mysql_fetch_array($sql_review))
							{
								$sql_client=mysql_fetch_array(mysql_query("select * from register where unique_code='$row_review[client_id]'"));
								
								$project=mysql_fetch_array(mysql_query("select * from post_projects where project_id='$row_review[project_id]'"));
							?>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Client Name</label>
                                    <label class="col-md-7 control-label"><?php echo $sql_client['first_name'].' '.$sql_client['last_name'];?></label>
                                </div>
                                <br>
                                <div class="form-group">		
                                ...
                                <br>
                                <div class="form-group">		
                                    <label class="col-md-3 control-label">Client Review</label>
                                    <label class="col-md-7 control-label" style="text-align:justify"><?php echo $row_review['client_message'];?></label>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Client Rating</label>
                                    <label class="col-md-7 control-label">	
										<?php
												$client_rate  =  $row_review['Client_Punctuality'] + $row_review['Client_Proffesionalism'] + $row_review['Client_Rehire'];
											...
											<?php 
												...
												echo "Punctuality <br>";
												for($x=1;$x<=$row_review['Client_Punctuality'];$x++) {
													echo '<img src="'.WebUrl.'images/rate_star.png" style="width:17px; margin-right:0px;"/>';
												}
												...
												for($x=1;$x<=$row_review['Client_Proffesionalism'];$x++) {
													echo '<img src="'.WebUrl.'images/rate_star.png" style="width:17px; margin-right:0px;"/>';
												}
												...
												echo "<br><br>";
												echo "Rehire <br>";
												for($x=1;$x<=$row_review['Client_Rehire'];$x++) {
													echo '<img src="'.WebUrl.'images/rate_star.png" style="width:17px; margin-right:0px;"/>';
												}
