			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						$client = mysql_fetch_array(mysql_query("SELECT * FROM register WHERE unique_code = '".$Code."' "));			
						...
						if(isset($_POST['EditClient']))
						{
							...
							if($InData)
							{
								...
								echo  '<div class="alert alert-success fade in">
													...
													<strong>Client Data Update Successfully!</strong>.
									   </div>';
										...
										<label for="UserId" class="error" id="UserId_error"></label>
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-user"></i></span>
													<input type="text" name="UserId" id="UserId" value="<?php echo $client['username'] ?>"  title="User Id" onFocus="if (this.value == 'UserId') {this.value = '';}" onBlur="UserIdCheck(this.value)" class="form-control bs-tooltip" >
										...
										<label for="UserEmail" class="error" id="UserEmail_error"></label>
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-envelope"></i></span>
													<input type="text" name="UserEmail" id="UserEmail" value="<?php echo $client['email'] ?>"  title="User Email" onFocus="if (this.value == 'UserEmail') {this.value = '';}" onBlur="UserEmailCheck(this.value)" class="form-control bs-tooltip" >
											</div>
										...
										<label for="FName" class="error" id="FName_error"></label>
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-cog"></i></span>
													<input type="text" name="FName" id="FName" value="<?php echo $client['first_name'] ?>"  title="First Name" onFocus="if (this.value == 'First Name') {this.value = '';}" onBlur="FNameCheck(this.value)" class="form-control bs-tooltip" >
											</div>
                                    </div>        
                               </div>
								...
								<label class="col-md-2 control-label">Last Name<span class="required">*</span></label>
									<div class="col-md-6">
										...
										<label for="LName" class="error" id="LName_error"></label>             
                                            <div class="input-group">
												<span class="input-group-addon"><i class="icon-cog"></i></span>
													<input type="text" name="LName" id="LName" value="<?php echo $client['last_name'] ?>"  title="Last Name" onFocus="if (this.value == 'Last Name') {this.value = '';}" onBlur="LNameCheck(this.value)" class="form-control bs-tooltip" >
											</div>
									</div>
						   </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="input-group-addon"><i class="icon-arrow-down"></i></span>
                                    ...
                                    <?php while($con = mysql_fetch_array($country)) :?>
                                    	<option <?php if($con['Name'] == $client['country']) : echo 'selected="selected"'; endif?> value="<?php echo $con['Code']; ?>" onClick="cityFetch()"><?php echo $con['Name']; ?></option>
                                    <?php endwhile ?>	
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="input-group-addon"><i class="icon-arrow-down"></i></span>
                                    <select name="city" id="city" onBlur="CityCheck(this.value)" onFocus="if (this.value == 'City') {this.value = '0';}" class="form-control bs-tooltip" title="City">
                                    	<?php $getlocation=mysql_fetch_array(mysql_query("select * from location where Name='".$client['country']."'"));
										...
										{?>
											<option value="<?php echo $rowgetcity['Name'];?>" <?php if($rowgetcity['Name']==$client['city']){ echo "selected"; };?>><?php echo $rowgetcity['Name'];?></option>
										...
										<div class="col-md-12" >
											<div class="table-actions">
													...
													<select class="btn btn-primary pull-center" style="background:#006666" name="status">
														<option <?php if($client['status'] == 'active'): echo 'selected="selcected"'; endif; ?> value="active">Active</option>
														<option <?php if($client['status'] == 'pending'): echo 'selected="selcected"'; endif; ?> value="pending">Pending</option>
														
													</select>
												
												<input type="submit" id="submit-visit" name="EditClient" value="Update" class="btn btn-primary pull-center">								
