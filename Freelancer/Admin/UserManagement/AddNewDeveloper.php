					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Add New developer</h4>
						...
						if(isset($_POST['AddNewdeveloper']))
						{
							...
							$insert		=	"INSERT INTO `register`(`id`, `first_name`, `last_name`, `email`, `username`, `password`, `country`, `city`, `hire`, `unique_code`, `register_date`, `status`) VALUES ('','$fname','$lname','$email','$UserId','$password','$cnt','$city','Work','$activation',CURDATE(),'$status')";
							...
							if($InData)
							{
								...
								echo  '<div class="alert alert-success fade in">
													...
													<strong>developer Data Insert Successfully!</strong>.
									   </div>';
									...
									<div class="table-footer">
										<div class="col-md-12" >
											<div class="table-actions">
												...
												<input type="submit" id="submit-visit" name="AddNewdeveloper" value="Add New developer" class="btn btn-primary pull-center">								
