			...
			<div class="container">
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> ADD NEW CITY</h4>
				...
				<?php 
						...
						if(isset($_POST['NewPageAdd']))
						{
							...
							$Insert	= "INSERT INTO city (CountryCode,Name,Status) values('".$country."','".$city."','".$Status."')";	
                            ...
                            <form name="individual_signup" class="form-horizontal row-border"  action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return CityFormValidation(this);" method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="country" class="form-control bs-tooltip" id="country" title="Country" onFocus="if (this.value == 'Country') {this.value = '';}" onBlur="countryCheck(this.value)">
                                                ...
                                                <?php
													...
													{
														echo '<option value="'.$row_location['Code'].'">'.$row_location['Name'].'</option>';
													}
												?>
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-cog"></i></span>
                                            <input type="text" name="City" id="City"  title="City Name" onFocus="if (this.value == 'City Name') {this.value = '';}" onBlur="cityCheck(this.value)" class="form-control bs-tooltip" >
