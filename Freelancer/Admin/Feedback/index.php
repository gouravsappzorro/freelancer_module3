...
<body>
	...
	//Fetch Data
				 ...
				 if(isset($_GET['AJCOde59']) and $_GET['AJCOde59'] !=='')
					   {
					   			$Delete = mysql_query("DELETE FROM feedback WHERE id = '".$_GET['AJCOde59']."' ");
								if($Delete)
								{
					   ...
					   if(isset($_SESSION['DeleteSu']) and $_SESSION['DeleteSu'] == 'Done' )
						{ 
							echo	'<div class="alert alert-success fade in">
											...
											<strong>Feedback Delete Successfull!</strong>.
									  </div>';
						...
						if(isset($_POST['Delete']))
						{
						  if(isset($_POST['Code'])) { $checkbox   =   $_POST['Code']; } else { $checkbox  = '';} 
						   ...
						   {
							 $del_id   =  $checkbox[$i];
							 $sql      = "DELETE FROM feedback WHERE id='$del_id'";
                 ...
                 <form name="individual_signup" action="" method="post" >
                 		<div class="widget box table-responsive">
							<div class="widget-header">
								...
								<h4><i class="icon-reorder"></i> View All Feedbacks</h4>
							...
							<?php 
                                    ...
                                    ?>
										<tr>
                                            ...
                                            <td class="align-center"><a href="Replay.php?TestCode=<?php echo $row['id']; ?>"><input type="button" name="Submit" value="Replay" class="btn btn-sm btn-warning"></a></td>
											<td class="align-center">
                                              <a href="./ViewFeedback.php?view=<?php echo $row['id'];?>" class="btn btn-sm bs-tooltip" title="View" class="bs-tooltip btn btn-xs">
