...
move_uploaded_file($_FILES["Image"]["tmp_name"],"./TestiMonialsImage/".$img);
$name1 = $img;
							...
							$Insert           =	"INSERT INTO admin_client SET
							CodeId            = '$CodeId',
							Status			='$Status',
							Name            =  '$Name',
															...
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="Name" id="Name"  title="Name" onFocus="if (this.value == 'Name') {this.value = '';}" onBlur="NameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
