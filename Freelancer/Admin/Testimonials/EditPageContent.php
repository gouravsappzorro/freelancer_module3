	...
	<div id="container">
		...
		<div id="content">
			<div class="container">
				...
				$Edit = mysql_fetch_array(mysql_query("SELECT * FROM admin_client WHERE CodeId = '$Code'"));
						if(isset($_POST['NewPageAdd']))
						{
						  
							$img			  = $_FILES['Image']['name'];
							$Name        = $_POST['Name'];
							$Description   = $_POST['PageContent'];
							$Status           = $_POST['Status'];
							$CodeId           = rand(100000, 999999);
							if($img)
							{
							move_uploaded_file($_FILES["Image"]["tmp_name"],"./ClientImage/".$img);
							$Bname = $img;
							...
							$Update           =	"UPDATE admin_client SET
							Status            =  '$Status',
							Name              =  '$Name',
				...
				<form name="individual_signup" class="form-horizontal row-border"  action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return JayCreatedValidForm(this);" method="post"  enctype="multipart/form-data">
						...
						<div class="form-group">
										...
										<div class="col-md-9">
															<label for="Image" class="error" id="Image_error"></label>
										
																<div class="input-group">
																	
																		<input type="file" name="Image" id="Image"  title="Image"  class="form-control bs-tooltip" >
																	</div>
										</div>
<a class="bs-tooltip" title="Click View for Show Image" href="javascript:openwindow('./TestiMonialsImage/<?php echo $Edit['Image']; ?>')"><font color="red"><b>View</b></font></a> 
									</div>
															...
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="Name" value="<?php echo $Edit['Name']; ?>"  id="Name"  title="Name" onFocus="if (this.value == 'Name') {this.value = '';}" onBlur="NameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9"><label for="Description" class="error" id="Description_error"></label>
														<section id="editor">
														<textarea id="PageContent" name="PageContent"  class="form-control"><?php echo $Edit['Description']; ?></textarea>
