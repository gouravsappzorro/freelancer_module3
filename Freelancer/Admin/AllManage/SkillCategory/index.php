...
<body>
	...
	<?php 
				 if(isset($_GET['AJCOde59']) and $_GET['AJCOde59'] !=='')
					   {
					   			$Delete = mysql_query("DELETE FROM admin_skill_category WHERE CodeId = '".$_GET['AJCOde59']."' ");
								if($Delete)
								{
				 ...
				 if(isset($_GET['DEAJ09148']) and $_GET['DEAJ09148'] !=='')
					   {
					   			$UPDATW = mysql_query("UPDATE admin_skill_category SET status = 'Published' WHERE CodeId = '".$_GET['DEAJ09148']."' ");
								if($UPDATW)
								{
				 ...
				 if(isset($_GET['ActAJ09148']) and $_GET['ActAJ09148'] !=='')
					   {
					   			$UPDATW = mysql_query("UPDATE admin_skill_category SET status = 'Pending' WHERE CodeId = '".$_GET['ActAJ09148']."' ");
								if($UPDATW)
								{
				...
				<?php 	if(isset($_SESSION['UpdateSu']) and $_SESSION['UpdateSu'] == 'Done' )
				 ...
				 ?>		
                  <p style="text-align:right;"><a href="AddNewSkillCategory.php"><input type="button" name="new" class="btn btn-primary pull-center" value="AddNewSkillCategory"></a></p>
                  	<form name="individual_signup" action="" method="post" >
						<div class="widget box table-responsive">
							<div class="widget-header">
						
								<h4><i class="icon-reorder"></i> View All Skill Category</h4>
							...
							<div class="widget-content no-padding">
								...
								<table class="table table-striped table-checkable table-hover">
									...
									<?php $i=0;
					 				...
					 				$res = mysql_query("SELECT  * FROM admin_skill_category ORDER BY Id DESC");
									...
									{	 ?>
										<tr>
											...
											<td><?php echo $Fw['skill_category']; ?></td>
...
Active														 </a>                
											<?php } ?>
														  <a href="./EditSkillPageContent.php?AJCOde59=<?php echo $Fw['CodeId']; ?>" title="Edit" class="btn btn-sm bs-tooltip">
