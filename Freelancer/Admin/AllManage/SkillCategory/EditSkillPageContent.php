	...
	<div id="container">
		...
		<div id="content">
			<div class="container">
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> EDIT SKILL CATEGORY</h4>
				...
				$Edit = mysql_fetch_array(mysql_query("SELECT * FROM admin_skill_category WHERE CodeId = '$Code'"));
						if(isset($_POST['NewPageAdd']))
						{
						  if($_POST["CategoryName"] == "")
							...
							$skill_category        = $_POST['CategoryName'];
							$Status           = $_POST['Status'];
							$CodeId           = rand(100000, 999999);
							
							$select =mysql_query("SELECT * FROM admin_skill_category where skill_category='$skill_category' and CodeId!='$Code'");
							$row=mysql_fetch_array($select);
							if(!$row["skill_category"])
							{				
							$Update           =	"UPDATE admin_skill_category SET
							Status            =  '$Status',
															...
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="CategoryName" value="<?php echo $Edit['skill_category']; ?>"  id="Name"  title="SkillName" onFocus="if (this.value == 'SkillName') {this.value = '';}" onBlur="SkillNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
