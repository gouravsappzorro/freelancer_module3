				...
				<?php 
						...
						if(isset($_POST['NewPageAdd']))
						{
						  if($_POST["CategoryName"] == "")
							...
							$select =mysql_query("SELECT * FROM `admin_category` where CategoryName='$CategoryName'");
							$row=mysql_fetch_array($select);
							if(!$row["CategoryName"])
							{
								$Insert           =	"INSERT INTO admin_category SET
							CodeId            = '$CodeId',
							Status			='$Status',
															...
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="CategoryName" id="Name"  title="CategoryName" onFocus="if (this.value == 'CategoryName') {this.value = '';}" onBlur="CategoryNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
