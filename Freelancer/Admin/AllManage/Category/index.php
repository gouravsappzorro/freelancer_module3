...
<body>
	...
	<?php 
				 if(isset($_GET['AJCOde59']) and $_GET['AJCOde59'] !=='')
					   {
								...
								$Delete1=mysql_query("DELETE FROM admin_subcategory WHERE Category_Id = '".$_GET['AJCOde59']."' ");
					   			$Delete = mysql_query("DELETE FROM admin_category WHERE Id = '".$_GET['AJCOde59']."' ");
				 ...
				 if(isset($_GET['DEAJ09148']) and $_GET['DEAJ09148'] !=='')
					   {
					   			$UPDATW = mysql_query("UPDATE admin_category SET Status = 'Published' WHERE CodeId = '".$_GET['DEAJ09148']."' ");
								if($UPDATW)
								{
				 ...
				 if(isset($_GET['ActAJ09148']) and $_GET['ActAJ09148'] !=='')
					   {
					   			$UPDATW = mysql_query("UPDATE admin_category SET Status = 'Pending' WHERE CodeId = '".$_GET['ActAJ09148']."' ");
								if($UPDATW)
								{
				...
				<?php 	if(isset($_SESSION['UpdateSu']) and $_SESSION['UpdateSu'] == 'Done' )
						{ 
							echo	'<div class="alert alert-success fade in">
											...
											<strong>Your Category Updated!</strong>.
								   </div>';
					   ...
					   if(isset($_SESSION['SETAcSu']) and $_SESSION['SETAcSu'] = 'Published' )
						{ 
							echo	'<div class="alert alert-success fade in">
											<i class="icon-remove close" data-dismiss="alert"></i>
											<strong>Your Selected Category Activated !</strong>.
									  </div>';
						  ...
						  if(isset($_POST['Code'])) { $checkbox   =   $_POST['Code']; } else { $checkbox  = '';} 
						    ...
						    for($i=0; $i<$count; $i++)
						   {
							 ...
							 $result   = mysql_query($sql);
							  $sql1     = "DELETE FROM admin_subcategory WHERE Category_Id='$del_id'";
				 ...
				 ?>	
                 <p style="text-align:right;"><a href="AddNewCategoryPage.php"><input type="button" name="new" class="btn btn-primary pull-center" value="AddNewCategory"></a></p>
                 	<form name="individual_signup" action="" method="post" >
						<div class="widget box table-respo">
							...
							<div class="widget-content no-padding">
								...
								<table class="table table-striped table-hover table-checkable table-colvis datatable dataTable">
                                    ...
                                    $res = mysql_query("SELECT  * FROM admin_category ORDER BY Id DESC");
									...
									<tr>
										...
										<td><?php echo $Fw['CategoryName']; ?></td>
									...
									<?php   if($Fw['Status'] == 'Published') 
										...
										<?php } ?>
													  <a href="./EditCategoryPageContent.php?AJCOde59=<?php echo $Fw['CodeId']; ?>" title="Edit" class="btn btn-sm bs-tooltip">
