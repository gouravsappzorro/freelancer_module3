...
<head>
	...
	<title>Admin Panel - Add Sub Category</title>
			...
			<div class="container">
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> ADD NEW SUBCATEGORY</h4>
				...
				<?php 
						...
						if(isset($_POST['NewPageAdd']))
						{
							...
							$select =mysql_query("SELECT * FROM `admin_subcategory` where SubCategory='$SubCategoryName'");
							$row=mysql_fetch_array($select);
							if(!$row["SubCategory"])
							{
								$Insert           =	"INSERT INTO admin_subcategory SET
							CodeId            = '$CodeId',
							Status			='$Status',
							...
							echo '<div class="alert alert-danger fade in">
										<i class="icon-remove close" data-dismiss="alert"></i>
										<strong>SubCategory Name Allready Exist.....</strong> .
									</div>';
										...
										<div class="col-md-9">
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
                                                                    ...
                                                                    <select name="CategoryName" title="CategoryName" onFocus="if (this.value == 'CategoryName') {this.value = '';}" onBlur="CategoryNameCheck(this.value)" class="form-control bs-tooltip">
                                                                    <option value="">Select Category</option>
                            										<?php 
																	 $query=mysql_query("SELECT  * FROM admin_category");
																	while($row=mysql_fetch_array($query)){
																	?>
                                                                    <option title="CategoryName" onFocus="if (this.value == 'CategoryName') {this.value = '';}" onBlur="CategoryNameCheck(this.value)" class="form-control" value="<?php echo $row['Id']; ?>"><?php echo $row['CategoryName']; ?></option>
                                                                    <?php } ?>
                                                                    </select>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input value="" type="text" name="SubCategoryName" id="Name"  title="SubCategoryName" onFocus="if (this.value == 'SubCategoryName') {this.value = '';}" onBlur="SubCategoryNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
