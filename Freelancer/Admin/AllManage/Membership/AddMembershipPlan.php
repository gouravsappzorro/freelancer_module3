...
<head>
	...
	<title>Admin Panel - Add Membership Plan</title>
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> ADD MEMBERSHIP PLAN</h4>
				...
				<?php 
						...
						if(isset($_POST['NewPageAdd']))
						{
						  ...
						  else
						  {
							...
							if(!$row["plan_name"])
							{
								$Insert           =	"INSERT INTO admin_membership_plan SET
							code            = '$CodeId',
							plan_name		= '$PlanName',
							price			= '$price',
							duration		= '$duration',
															...
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="PlanName" id="Name"  title="SkillName" onFocus="if (this.value == 'SkillName') {this.value = '';}" onBlur="SkillNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="price" id="Name"  title="SkillName" onFocus="if (this.value == 'SkillName') {this.value = '';}" onBlur="SkillNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="duration" id="Name"  title="SkillName" onFocus="if (this.value == 'SkillName') {this.value = '';}" onBlur="SkillNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="bids" id="Name"  title="SkillName" onFocus="if (this.value == 'SkillName') {this.value = '';}" onBlur="SkillNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
