				...
				<?php 
						...
						if(isset($_POST['NewPageAdd']))
						{
						  ...
						  else
						  {
							...
							if(!$row["Currency"])
							{
								$Insert           =	"INSERT INTO admin_currency SET
							CodeId            = '$CodeId',
							Status			='$Status',
															...
															<label for="Name" class="error" id="Name_error"></label>
																...
																<div class="input-group">
																	<span class="input-group-addon"><i class="icon-cog"></i></span>
																		<input type="text" name="CurrencyName" id="Name"  title="CurrencyName" onFocus="if (this.value == 'CurrencyName') {this.value = '';}" onBlur="CurrencyNameCheck(this.value)" class="form-control bs-tooltip" >
																	</div>
										</div>
