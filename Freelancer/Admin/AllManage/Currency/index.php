...
<body>
	...
	<?php 
				 if(isset($_GET['AJCOde59']) and $_GET['AJCOde59'] !=='')
					   {
					   			$Delete = mysql_query("DELETE FROM admin_currency WHERE CodeId = '".$_GET['AJCOde59']."' ");
								if($Delete)
								{
				 ...
				 if(isset($_GET['DEAJ09148']) and $_GET['DEAJ09148'] !=='')
					   {
					   			$UPDATW = mysql_query("UPDATE admin_currency SET Status = 'Published' WHERE CodeId = '".$_GET['DEAJ09148']."' ");
								if($UPDATW)
								{
				 ...
				 if(isset($_GET['ActAJ09148']) and $_GET['ActAJ09148'] !=='')
					   {
					   			$UPDATW = mysql_query("UPDATE admin_currency SET Status = 'Pending' WHERE CodeId = '".$_GET['ActAJ09148']."' ");
								if($UPDATW)
								{
				...
				<?php 	if(isset($_SESSION['UpdateSu']) and $_SESSION['UpdateSu'] == 'Done' )
						{ 
							echo	'<div class="alert alert-success fade in">
											...
											<strong>Your Currency Updated Successfully!</strong>.
								   </div>';
					   ...
					   if(isset($_SESSION['DeleteSu']) and $_SESSION['DeleteSu'] == 'Done' )
						{ 
							echo	'<div class="alert alert-success fade in">
											<i class="icon-remove close" data-dismiss="alert"></i>
											<strong>Your Currency Deleted Successfully!</strong>.
									  </div>';
					   ...
					   if(isset($_SESSION['SETAcSu']) and $_SESSION['SETAcSu'] = 'Published' )
						{ 
							echo	'<div class="alert alert-success fade in">
											<i class="icon-remove close" data-dismiss="alert"></i>
											<strong>Your Selected Currency Activated !</strong>.
									  </div>';
					   ...
					   if(isset($_SESSION['SETAcSu']) and $_SESSION['SETAcSu'] = 'Pending')
						{ 
							echo	'<div class="alert alert-success fade in">
											<i class="icon-remove close" data-dismiss="alert"></i>
											<strong>Your Selected Currency Deactivated !</strong>.
									  </div>';
						    unset($_SESSION['SETAcSu']);
			           }
						...
						if(isset($_POST['Delete']))
						{
						  if(isset($_POST['Code'])) { $checkbox   =   $_POST['Code']; } else { $checkbox  = '';} 
						   ...
						   {
							 $del_id   =  $checkbox[$i];
							 $sql      = "DELETE FROM admin_currency WHERE CodeId='$del_id'";
				 ...
				 ?>		
            <p style="text-align:right;"><a href="AddNewCurrency.php"><input type="button" name="new" class="btn btn-primary pull-center" value="AddNewCurrency"></a></p>
           		<form name="individual_signup" action="" method="post" >		   
						<div class="widget box table-responsive">
							<div class="widget-header">
						
								<h4><i class="icon-reorder"></i> View All Currency</h4>
							...
							<div class="widget-content no-padding">
								...
								<table  class="table table-striped  table-hover table-checkable table-colvis datatable dataTable" id="example">
									...
									<?php $i=0;
                                    $res = mysql_query("SELECT * FROM admin_currency ORDER BY Id DESC");
                                    ...
                                    {	 ?>
                                    	<tr>
                                            ...
                                            <?php } ?>
                                                <a href="./EditCurrencyPageContent.php?AJCOde59=<?php echo $Fw['CodeId']; ?>" title="Edit" class="btn btn-sm bs-tooltip">
