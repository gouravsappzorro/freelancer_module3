...
if (isset($_POST['SliderUpdate']))
{
		...
		$SubTitle3 = $_POST['subtitle3'];
		 ...
		 if(isset($SImage1))
		 {
		 	move_uploaded_file($_FILES["SImage1"]["tmp_name"],"./SliderImage/".$_FILES["SImage1"]["name"]);
		 }	
		 if(isset($SImage2))
		 {
		 	move_uploaded_file($_FILES["SImage2"]["tmp_name"],"./SliderImage/".$_FILES["SImage2"]["name"]);
		 }	
		 if(isset($SImage3))
		 {
		 	move_uploaded_file($_FILES["SImage3"]["tmp_name"],"./SliderImage/".$_FILES["SImage3"]["name"]);
		 }	
		...
		$sql="UPDATE `admin_slider` SET `Slider1`='".$SImage1."',`Slider2`='".$SImage2."',`Slider3`='".$SImage3."',`Title1`= '".$STitle1."',`Title2`='".$STitle2."',`Title3`='".$STitle3."',`SubTitle1`='".$SubTitle1."',`SubTitle2`='".$SubTitle2."',`SubTitle3`='".$SubTitle3."' WHERE CodeId =  '".$CodeId."' AND Status = 'Active'";
