...
<?php include "EditProjectvalidation.php";?>
				...
				<form name="update_projects" class="form-horizontal"  action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return ProjectValidation(this);" method="post"  enctype="multipart/form-data">
										...
										<label for="Skills" class="error" id="required_skill_error"></label>
											<div class="input-group">
                            					...
                            					<?php $skill_res=mysql_query("select * from admin_skill");
		  										...
		  										{
												?>
                            					<option value="<?php echo $row['Skill_Name']; ?>" <?php if($project['skills']==$row['Skill_Name']){?> selected <?php }?>><?php echo $row['Skill_Name']; ?></option>
                            					<?php }?>
                          						</select>
									...
									<div class="col-md-6">
										...
										<label for="offer" class="error" id="file_error"></label>             
                                            <div class="input-group">
                                                ...
                                                <label class="radio-inline"><input type="radio" class="uniform" name="accept_offers" id="accept_offers" onBlur="offerCheck();" value="freelancer" <?php if($project['accept_offers']=='freelancer'){?> checked<?php }?> > Freelancer </label>
                                                <label class="radio-inline"><input type="radio" class="uniform" name="accept_offers" id="accept_offers" onBlur="offerCheck();" value="company" <?php if($project['accept_offers']=='company'){?> checked<?php }?> > Company </label>
                                                <label class="radio-inline"><input type="radio" class="uniform" name="accept_offers" id="accept_offers" onBlur="offerCheck();" value="both" <?php if($project['accept_offers']=='both'){?> checked<?php }?> > Both </label>
                           ...
                           <div class="form-group">
								...
								<div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                    	...
                                    	<label class="checkbox-inline"><input type="checkbox" class="uniform" name="competible[]" id="competible" value="mobiles" <?php if(in_array('mobiles',$comp)){echo 'checked="checked"';}?>> Mobiles </label>
                                                
										<label class="checkbox-inline"><input type="checkbox" class="uniform" name="competible[]" id="competible" value="pc" <?php if(in_array('pc',$comp)){echo 'checked="checked"';}?>> PC </label>
                                                
                                        <label class="checkbox-inline"><input type="checkbox" class="uniform" name="competible[]" id="competible" value="tablets" <?php if(in_array('tablets',$comp)){echo 'checked="checked"';}?>> Tablets </label>
                                                
                                        <label class="checkbox-inline"><input type="checkbox" class="uniform" name="competible[]" id="competible" value="ipads" <?php if(in_array('ipads',$comp)){echo 'checked="checked"';}?>> iPads </label>
								</div>
							</div>
						</div>
                        ...
                        <label class="col-md-2 control-label">Type of project<span class="required">*</span></label>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                	<label class="radio-inline"><input type="radio" class="uniform" name="project_type" id="project_type" onBlur="project_typeCheck();" value="fixed" <?php if($project['type_of_project']=='fixed'){ echo "checked='checked'";}?>> Fixed Price </label>
                                    
                                    <label class="radio-inline"><input type="radio" class="uniform" name="project_type" id="project_type" onBlur="project_typeCheck();" value="hourly" <?php if($project['type_of_project']=='hourly'){ echo "checked='checked'";}?>> Hourly</label>
								...
								<label class="col-md-2 control-label">Help us improve, is there another section you were missing?<span class="required">*</span></label>
									<div class="col-md-6">
										...
										<label for="improve" class="error" id="project_des_error"></label>
											<div class="input-group">
												<span class="input-group-addon"><i class="icon-cog"></i></span>
													<textarea name="improve"  class="form-control bs-tooltip" id="improve" placeholder="Help us improve, is there another section you were missing?" rows="10" style="width:100%;" title="Help" onFocus="if (this.value == 'Help') {this.value = '';}"><?php echo$project['help'];?></textarea>
											</div>
                                    </div>        
                               </div>
								<div class="row">
