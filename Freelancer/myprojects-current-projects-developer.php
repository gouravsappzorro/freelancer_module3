...
<?php
	...
	{
		$query=mysql_query("select * from post_projects where developer_id='$_SESSION[id]' and status='award'");
		...
		$res = mysql_query("select * from post_projects where developer_id='$_SESSION[id]' and status='award' order by id desc LIMIT ".$per_page." OFFSET ".$offset);
		...
		if(mysql_affected_rows())
		{
            ...
            <div class="row-fluid">	
				...
				<div class="span1">
					<p><?php if($row['type_of_project']=='fixed'){ echo $user_bids['duration'].' Days';}else {echo $user_bids['duration'].' Hours';}?></p>
				</div>
