...
<?php	
	...
	$returnUrl = WebUrl."browse_detail_client.php?project_id=".$_GET['project_id']."&developer=".$_GET['developer']."&admin_payment";
...
<?php
	...
	$commision=$_SESSION['commision_admin'];
	$fee=$_SESSION['remain_pay'];
	
	$admin_id=$admin['paypal_account'];;
	//$developer_id="bhavinthummar100_buyer8@gmail.com";
	$developer_id=$developer['paypal_Account'];
?>
				...
				<table class="params" id="receiverTable">
					...
					<tr id="receiverTable_0">
						...
						<td>-->
                            ...
                            <input type="hidden" name="receiverEmail[0]" id="receiveremail_0" value="<?php echo $admin_id;?>">
                            
                            <input type="hidden" name="receiverEmail[1]" id="receiveremail_1" value="<?php echo $developer_id;?>">
                            
						<!--</td>
						<td>-->
<!--							<input type="text" name="receiverAmount[]" id="amount_0" value="1.0" class="smallfield">-->

<input type="hidden" name="receiverAmount[0]" id="amount_0" value="<?php echo $commision;?>" class="smallfield">

<input type="hidden" name="receiverAmount[1]" id="amount_1" value="<?php echo $fee;?>" class="smallfield">

						<!--</td>
						<td>-->
                        
							<input type="hidden" name="phoneCountry[0]" id="phoneCountry_0" value="" class="xsmallfield" /> 
                            <input type="hidden" name="phoneCountry[1]" id="phoneCountry_1" value="" class="xsmallfield" />
                             
							<input type="hidden" name="phoneNumber[0]" id="phoneNumber_0" value="" class="xsmallfield" />
                            <input type="hidden" name="phoneNumber[1]" id="phoneNumber_1" value="" class="xsmallfield" />
                            
							<input type="hidden" name="phoneExtn[0]" id="phoneExtn_0" value="" class="xsmallfield" />
                            <input type="hidden" name="phoneExtn[1]" id="phoneExtn_1" value="" class="xsmallfield" />
						...
						<td>-->
                            ...
                            <input type="hidden" name="primaryReceiver[1]" id="primaryReceiver_1" class="smallfield" value="false">
						...
						<td>-->
                            ...
                            <input type="hidden" name="invoiceId[1]" id="invoiceid_1" value="" class="smallfield">
						...
						<td>-->
                            ...
                            <input type="hidden" name="paymentType[1]" id="paymentType_1" value="SERVICE" class="smallfield">
                            
						<!--</td>
						<td>-->
                        
							<input type="hidden" name="paymentSubType[0]" id="paymentSubType_0" value="" class="smallfield">
                            <input type="hidden" name="paymentSubType[1]" id="paymentSubType_1" value="" class="smallfield">
