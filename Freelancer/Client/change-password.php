...
{
	var a = currentpassCheck(document.getElementById("current_pass").value);
	var b = passwordCheck(document.getElementById("new_pass").value);
	var c = confirmpassCheck(document.getElementById("confirm_pass").value);
							   ...
							   <div id="sidebar" class="span3 sidebar sidebar-left" style="">
									<div class="inner-content">
										<ul class="side-navigation">
											...
											<li class="page_item page-item-639 current_page_item"><a href="<?php echo WebUrl; ?>Client/change-password.php">Change Password</a></li>
