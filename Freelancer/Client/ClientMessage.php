...
function updatenotification(project_id,developer_id){

$.ajax({

		type:"POST",
		url:"notification.php",
		data:{project_id:project_id,developer_id:developer_id},
...
updatenotification('<?php echo $_GET['project_id']; ?>','<?php echo $_GET['code'];?>');
...
<?php 
   ...
   $developer_details=mysql_fetch_array(mysql_query("select * from register where unique_code='".$_GET['code']."'"));
...
<script type="text/javascript" src="ClientMessageValid.js"></script>
<script type="text/javascript">
...
if(isset($_POST['project_id']) && $count==0)
{
	...
	$Message_Data=mysql_query("INSERT INTO message(developer_id,client_id,project_id,Sender_Id,Files,ReadStatus,Date)values('".$developer_id."','".$client_id."','".$project_id."','".$client_id."','".$Files."','1','".showcurrenttime()."')");
	...
	if($Message_Data){
		...
		$to       = $developer_details['email'];
		$subject  = $developer_details['first_name'].' '.$developer_details['last_name'].", you have received a message from ".$client_details['first_name'].' '.$client_details['last_name'];
		$header   = "Webzira.com"; 
		$msg='
			...
			<div bgcolor="#e5e5e1" style="margin:0;padding:0">
				<table width="100%" bgcolor="#e5e5e1" cellspacing="0" cellpadding="0">
					<tbody>
						...
						Hi,'.$developer_details['first_name']." ".$developer_details['last_name'].'!
										</td>
									</tr>
									<tr>
						<td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#000;line-height:24px;word-spacing:1px;">User Name : \''.$developer_details['username'].'\'</td>
						</tr>
									<tr>
					   ...
					   You have received new message from <strong>'.$client_details['first_name'].' '.$client_details['last_name'].'</strong>. 
									
						<br /><br>
						
						<a style="background:#41b7d8 none repeat scroll 0 0; color:white; padding:10px 20px; text-decoration:none; font-family: Source Sans Pro,sans-serif; font-size:20px;" href="'. WebUrl.'Developer/DeveloperMessage.php?project_id='.$_GET['project_id'].'" >View Message</a>
	...
	<div class="container">
    	<div class="row">
			...
			<div class="col-md-12" style="background-color: #fff;">
         	<br/>
			<div class="theme_box">
				<div class="col-md-6"><h2>Messages Management</h2></div>
				<div class="col-md-6">
                
				<?php if(isset($_GET['var'])==1){?>
                
      				<a href="<?php echo WebUrl;?>Client/message.php"><button name="Update" class="btn yellow-btn " type="button" style="margin:0px; float:right; width:auto" ><strong><i class="fa fa-arrow-left"></i> Back</strong></button></a>
                
				<?php }else { ?>
                
                	<a href="<?php echo WebUrl;?>browse_detail_client.php?project_id=<?php echo $_GET['project_id'];?>"><button name="Update" class="btn yellow-btn " type="button" style="margin:0px; float:right; width:auto" ><strong><i class="fa fa-arrow-left"></i> Back</strong></button></a>
					...
					<div class="col-md-12">
                		<div id="message_box">
							<div class="message_box" id="cover">
								...
								$Message_details=mysql_query("select * from message where project_id='".$_GET['project_id']."' and client_id='".$_SESSION['id']."' and developer_id='".$_GET['code']."'");           
              					...
              					if($Total==0)
								{
              					...
              					{ 
              						...
              						{
										if($Message_Data['Sender_Id']==$Message_Data['client_id'])
              							{
							                if($Message_Data['Message']!='')
                							{
           						?>
                  							<div class="clear_row" style="clear:both">
                        						<div class="col-md-1 message_sender"><img title="<?php echo $client_details['first_name'].' '.$client_details['last_name']; ?>" src="<?php echo WebUrl;?>Profile Picture/<?php echo $client_details['profile_picture']; ?>" width="40" height="40" style=" float:right;border-radius: 50%;" onError="this.src='<?php echo WebUrl;?>Profile Picture/no_image.jpg'">
                                                </div>
            					...
            					<?php 
                						...
                						else
                						{
                							...
                							else if($Message_Data['Files']!='')
                							{
							                    ...
							                    $FIles_Total=count($Files);
                								?>
	        							        <div class="row clear_row"><div class="col-md-2 message_reciver"><img title="<?php echo $developer_details['first_name'].' '.$developer_details['last_name']; ?>" src="<?php echo WebUrl;?>Profile Picture/<?php echo $developer_details['profile_picture'];?>" width="40" height="40" style=" float:right;border-radius: 50%;" onError="this.src='<?php echo WebUrl;?>Profile Picture/no_image.jpg'"></div>
          				...
          				<div class="row">
                            ...
                            <div class="col-md-11" style="margin-bottom:50px">
                                ...
                                <textarea name="Message"  id="Message" class="form-control" style="height:40px !important; margin-top:5px;" placeholder="Type Your Message Here...."></textarea><br/>
                                <div id="Message_error" class="error"><?php echo @$error;?></div>
